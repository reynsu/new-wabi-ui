...
function WidgetRail({
  ...
  return (
    ...
    >
      ...
      {/* The switch between the board and a preview crosses over instead of
          snapping: it's a change of content in a region that stays, so the step
          is `moderate` —the popups' and the tabs'— and not the dialogs'.
