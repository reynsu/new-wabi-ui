...
// The registry ships this component for Next.js, where `Link` is an anchor
// that takes `href`. This app is Vite + React, so it gets a plain anchor.
// Swap in your router's Link here if you add one.
